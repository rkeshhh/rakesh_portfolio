...
function Skills() {
    ...
    return (
        <section id="skills" className="py-16 sm:py-20 bg-[#0a192f] text-center px-4 sm:px-6" data-aos="fade-up">
            ...
            <div className="grid gap-6 sm:gap-8 max-w-5xl mx-auto md:grid-cols-2">
                ...
                <div
                    className="border border-[#64ffda]/30 rounded-lg p-4 sm:p-6 transition-transform duration-300 hover:shadow-[0_0_20px_rgba(100,255,218,0.5)] focus:shadow-[0_0_20px_rgba(100,255,218,0.5)] active:shadow-[0_0_20px_rgba(100,255,218,0.5)] cursor-pointer"
                    data-aos="fade-right"
                >
