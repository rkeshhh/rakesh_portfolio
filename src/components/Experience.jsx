...
function Experience() {
  ...
  return (
      <section id="experience" className="py-20 px-6 sm:px-8 bg-[#0a192f] text-center" data-aos="fade-up">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {experiences.map((exp, i) => (
              <div
                  ...
                  data-aos="zoom-in"
                  className="bg-gray-800 p-6 rounded-lg shadow-lg cursor-pointer transition-transform duration-300
